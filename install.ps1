<#
	.SYNOPSIS
		Installs the SecretManagement.NetwrixPasswordSecure Module from github
		
	.DESCRIPTION
		This script installs the SecretManagement.NetwrixPasswordSecure Module from github.
...
$BaseUrl = "https://github.com/<InsertUsernameHere>/SecretManagement.NetwrixPasswordSecure"

# If the module is in a subfolder of the cloned repository, specify relative path here. Empty string to skip.
$SubFolder = "SecretManagement.NetwrixPasswordSecure"
