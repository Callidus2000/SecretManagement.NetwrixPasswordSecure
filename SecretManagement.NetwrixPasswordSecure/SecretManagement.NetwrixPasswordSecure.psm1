...
$script:doDotSource = Get-PSFConfigValue -FullName SecretManagement.NetwrixPasswordSecure.Import.DoDotSource -Fallback $false
if ($SecretManagement.NetwrixPasswordSecure_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName SecretManagement.NetwrixPasswordSecure.Import.IndividualFiles -Fallback $false
if ($SecretManagement.NetwrixPasswordSecure_importIndividualFiles) { $importIndividualFiles = $true }
