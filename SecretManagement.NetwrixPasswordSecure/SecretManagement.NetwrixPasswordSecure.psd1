@{
	...
	PrivateData       = @{
		...
		PSData = @{
			...
			LicenseUri = 'https://raw.githubusercontent.com/Callidus2000/SecretManagement.NetwrixPasswordSecure/main/LICENSE'

			# A URL to the main website for this project.
			ProjectUri = 'https://github.com/Callidus2000/SecretManagement.NetwrixPasswordSecure/'
