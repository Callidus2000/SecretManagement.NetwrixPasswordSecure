...
Remove-Module SecretManagement.NetwrixPasswordSecure.Extension -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SecretManagement.NetwrixPasswordSecure.Extension.psd1"
Import-Module "$PSScriptRoot\..\SecretManagement.NetwrixPasswordSecure.Extension.psm1" -Force
