...
Set-PSFConfig -Module 'SecretManagement.NetwrixPasswordSecure.Extension' -Name 'Example.Setting' -Value 10 -Initialize -Validation 'integer' -Handler { } -Description "Example configuration setting. Your module can then use the setting using 'Get-PSFConfigValue'"
#>

Set-PSFConfig -Module 'SecretManagement.NetwrixPasswordSecure.Extension' -Name 'Import.DoDotSource' -Value $false -Initialize -Validation 'bool' -Description "Whether the module files should be dotsourced on import. By default, the files of this module are read as string value and invoked, which is faster but worse on debugging."
Set-PSFConfig -Module 'SecretManagement.NetwrixPasswordSecure.Extension' -Name 'Import.IndividualFiles' -Value $false -Initialize -Validation 'bool' -Description "Whether the module files should be imported individually. During the module build, all module code is compiled into few files, which are imported instead by default. Loading the compiled versions is faster, using the individual files is easier for debugging and testing out adjustments."
...
Set-PSFConfig -Module 'SecretManagement.NetwrixPasswordSecure.Extension' -Name 'ConsoleLogging.MaxLevel' -Value 1 -Initialize -Validation integer -Description "Up to which level should messages be sent to the provider?"
