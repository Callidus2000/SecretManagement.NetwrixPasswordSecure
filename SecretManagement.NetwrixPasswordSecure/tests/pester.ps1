...
Remove-Module SecretManagement.NetwrixPasswordSecure -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SecretManagement.NetwrixPasswordSecure.psd1"
Import-Module "$PSScriptRoot\..\SecretManagement.NetwrixPasswordSecure.psm1" -Force
