...
If you don't care to deal with the details, this is what you need to do to get started seeing results:
 ...
 - Update the `FunctionsToExport` node in the module manifest (SecretManagement.NetwrixPasswordSecure.psd1). All functions you want to publish should be in a list.
